...
class ChangeLocalizationTask {
    ...
    func recordResponse(selectedIndex: Int) {
        ...
        // Note: Haptic feedback already provided on tap for user confirmation
        // Response correctness is tracked silently for research data
        
        delegate?.task(self, didReceiveResponse: isCorrect, reactionTime: reactionTime, selectedIndex: selectedIndex, setSize: trial.setSize, trial: trial.trialNumber)
